...
#### Grafik Output Program (6 Rumah):

![Grafik Perkembangan Fitness TSP - 6 Rumah](hasil_tsp_6_houses.png)

**Analisis Grafik:**
- **Left Plot (Fitness Curve):**
  - Green line (Best Fitness): Menunjukkan fitness terbaik meningkat dari Gen 1 ke Gen 100
  - Blue line (Average Fitness): Rata-rata populasi mengikuti trend naik
  - Red line (Worst Fitness): Fitness terburuk juga naik (due to elitism)
  - Konvergensi terlihat sekitar Gen 50-60 (kurva mulai flat)

- **Right Plot (Best Route Visualization):**
  - Titik merah: Lokasi 6 rumah dengan nomor label
  - Arrow biru: Rute perjalanan dari rumah ke rumah
  - Ini adalah rute terbaik yang ditemukan setelah 100 generasi
...
```python
- Main GA loop
- 100 iterations per generasi
- Track best/avg/worst fitness
- Visualize dan save results
```

---

## [5] KODE PROGRAM LENGKAP (TugasPraktikum_TSP.py)
